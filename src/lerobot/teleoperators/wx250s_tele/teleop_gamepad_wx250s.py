...
from .gamepad_wx250s_conf import GamepadWX250STeleopConfig
from .gamepad_utils import GamepadController as Gamepad



class GamepadWX250STeleop(Teleoperator):
    """
    Teleop class to use gamepad inputs for control.
    """

    config_class = GamepadWX250STeleopConfig
    name = "gamepad_wx250s"

    def __init__(self, config: GamepadWX250STeleopConfig):
    ...
    def connect(self) -> None:
        self.gamepad = Gamepad(
            translational_sens=self.config.translational_sens, 
            rotational_sens=self.config.rotational_sens
        )
        self.gamepad.start()
    ...
    def get_action(self) -> dict[str, Any]:
        ...
        actions = self.gamepad.get_deltas()
        ...
        action_dict = {
            ...
            "delta_pitch": actions[4],
            "delta_yaw": actions[5],
            "gripper": self.gamepad.gripper_command,
        }
